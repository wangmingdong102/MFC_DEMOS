...
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Text(pDX, IDC_EDIT1, nn_param_1);
	DDX_Text(pDX, IDC_EDIT2, nn_param_2);
	DDX_Text(pDX, IDC_EDIT3, nn_param_result);
}
...
void CMFCApplication1Dlg::OnEnChangeEdit1()
{
	...
	printf("OnEnChangeEdit param 1:%lf param 2:%lf result:%lf\n", nn_param_1, nn_param_2, nn_param_result);
	// nn_20190728 add 
}
